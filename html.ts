    									...
    									<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
    										<tr>
    											<td style="font-family: sans-serif; font-size: 15px; vertical-align: top;">
    												...
    												<p style="font-family: sans-serif; font-size: 15px; font-weight: normal; margin: 0; Margin-bottom: 15px;">You have received a ${data.$name} submission from <a href="${data.$domain}" target="_blank" style="display: inline-block; box-sizing: border-box; cursor: pointer; font-size: 15px;">${data.$domain}</a>.</p>
